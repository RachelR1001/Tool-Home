...
//Specify the URL
    ...
    if (httpCode > 0) {
      ...
      if(requestFlag!= serviceType){
          requestFlag = serviceType;
      ...
      // if (serviceType == "Borrow" && objCode != "") {
        ...
        // if(firstLetter == "A") {
            ...
            digitalWrite(dirPin, LOW); // 设置电机方向
          Serial.println("move:"); 
           for(int step = 0; step < 200; step++){
            ...
            delay(500);
            shelfFlag = "1";
            server.on("/shelf_ready", HTTP_GET, [](AsyncWebServerRequest *request){
            
            request->send(200, "text/plain", shelfFlag);
            // requestFlag = "";
